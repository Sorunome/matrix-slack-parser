...
describe("SlackMessageParser", () => {
	...
	describe("attachments", () => {
		it("should handle blank attachments", async () => {
			...
			expect(ret.formatted_body).to.equal("<p></p>");
		});
		it("should handle attachments with pretext", async () => {
			...
			expect(ret.formatted_body).to.equal("<p><strong>yay</strong><br></p>");
		});
		it("should handle attachments with an author", async () => {
			...
			expect(ret.formatted_body).to.equal("<p>Fox<br></p>");
		});
		...
		it("should handle attachment fields", async () => {
			...
			expect(ret.formatted_body).to.equal("<p><table><tr><td><strong>a</strong><br>1</td>" +
		...
		it("should handle attachment image_url's", async () => {
			...
			expect(ret.formatted_body).to.equal("<p>Image: " +
